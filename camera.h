...
class camera {
    ...
    /* Public Camera Parameters Here */
        ...
        double aspect_ratio = 1.0;  // ratio fo width / height
        ...
        void render(const hittable& world) {
            ...
            std::cout << "P3 " << image_width << ' ' << image_height << "\n255\n"; // one little wrong space here can fuckup the format of the image file
    ...
    private:
        ...
        void initialize() {
            ...
            // horizontal and vertical delat vectors from pixel to pixel
